    ...
    <div className="flex flex-wrap flex-col -m-4 w-[110%]">
      {sortedMarketsArray.map((market) => (
        <div key={market.adj_ticker} className="p-4 w-full">
          <div className="w-full md:max-w-none border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col" style={{ height: "12em", width: "auto", maxWidth: "750px" }}>
